#!/usr/bin/env sh
# Universal installer for repo-roast. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/repo-roast.git"
echo "Installing repo-roast ..."
