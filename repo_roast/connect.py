"""Native cognis-connect emit for repo-roast — forward findings to any platform.

Maps repo-roast's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    repo-roast ... --format json | repo-roast-emit --to stix
    repo-roast-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
